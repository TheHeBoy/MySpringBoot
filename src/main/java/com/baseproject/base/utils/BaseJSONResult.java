package com.baseproject.base.utils;
...
public class BaseJSONResult {
    ...
    public static BaseJSONResult errorMsg(String msg) {
        return new BaseJSONResult(500, msg, null);
    }

    public static BaseJSONResult errorMap(Object data) {
        return new BaseJSONResult(501, "error", data);
    }
    ...
    public BaseJSONResult(Integer status, String msg, Object data) {
        this.status = status;
        this.msg = msg;
        this.data = data;
    }
